...
public class DatabaseInitializer implements CommandLineRunner
{
    ...
    public void run(String... args) throws Exception
    {
        ...
        User userOne = saveUser("https://avatars.githubusercontent.com/u/100943442?v=4", "Vik", "Mandarin", "Bulgaria", 10.50, "(+359) 929292929", "Sofia, Borovo");
        User userTwo = saveUser("https://avatars.githubusercontent.com/u/119004862?v=4", "Peter", "BigPapa", "France", 789.00, "(+33) 140000000", "Paris, Belleville");
        User userThree = saveUser("https://static.vecteezy.com/system/resources/previews/028/794/707/non_2x/cartoon-cute-school-boy-photo.jpg", "Kris", "OneManArmy", "United Kingdom", 1500.00, "(+44) 7015212467", "London, Chiswick");
    ...
    {
        Transaction transaction = Transaction.builder().owner(owner).type(type).createdOn(createdOn).amount(amount).build();

        transactionRepository.save(transaction);
    }

    private User saveUser(String profilePictureUrl, String firstName, String username, String country, double balance, String phoneNumber, String address)
    {
        User user = User.builder().profilePictureUrl(profilePictureUrl).firstName(firstName).username(username).country(country).balance(balance).phoneNumber(phoneNumber).address(address).build();
